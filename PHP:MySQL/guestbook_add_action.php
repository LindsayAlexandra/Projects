...
// guestbook_add_action.php Revision 7 11-20-13 11:45am
...
if (!$result) {
	 ...
	 echo "<p style='color:green;'>4. Query succeeded! Your data was added.</p>";
